  ...
  Profile.findOne({ activeProfile: true }, function(err, profile) {
    ...
    if (!profile) {
      ...
      var defaultProfile = new Profile({
        ...
        location: [
          {name: 'Silicon Valley', url: 'https://goo.gl/maps/yA6gDxKgoTU2'}
        ],
        contacts: [
          {name: '@my_twitter_handle', url: 'http://twitter.com/my_twitter_handle'},
          {name: 'my_email@email.com', url: 'mailto:my_email@email.com'}
        ],
        links: [
          {name: 'github.com/my_github_username', url: 'http://github.com/my_github_username'},
          {name: 'my-blog.com', url: 'http://my-blog.com'}
        ],
        techIcons: [
